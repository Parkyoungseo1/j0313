...
public class T06_replace {
	public static void main(String[] args) {
		...
		System.out.println("2.'한글'을 '미국'로 변경하시오 : " + msg2.replace("한국", "미국"));		
		System.out.println("3.'o'을 'O'로 변경하시오 : " + msg1.replace("o", "O"));		
		System.out.println("4.'o'을 'O'로 변경하시오 : " + msg1.replaceAll("o", "O"));	// 검색어에 '정규식'을 사용할때 replaceAll사용한다.
		System.out.println();
		...
		System.out.println(msg3.repeat(3)); //repeat() : java 10이후 사용가능.
