...
public class Test {
	public static void main(String[] args) {
	  ...
	  // 소수 첫째자리에서 반올림 : 1234.567 + 0.5 = (int)1235.067 = 1235
	  // 소수 둘째자리에서 반올림 : 1234.567 + 0.05 = (int)1234.617 * 10 = (int)123456.17 = 12346 /10 =1234.6 
	  System.out.println(Math.round(d1*10) / 10.0);
	  // 소수 셋째자리에서 반올림 : 1234.567 + 0.005 = (int)1234.572* 100 = (int)123457.2 = 123457 /100 =1234.57 
	  ...
	  //System.out.println("6.min() : " + Math.count(10, 20, 30)); (X)// 자바에서 개수를 구할때는 lengh() 또는 size() 이용
	  // lengh() : 문자열 또는 배열, size() : 객체배열이나 클래스에서 사용, sizeOf() : 바이트수 계산
	  System.out.println();
	  
	  // 난수 : Math.random() : 0~1미만의 실수형 난수, (int)(Math.random()*(끝+1-시작))+시작)
	  System.out.println("0~1미만의 난수  : " + Math.random());
	  System.out.println("0~100까지의 난수  : " + ((int)(Math.random()*100)+1));
	  System.out.println("0~10까지의 난수  : " + ((int)(Math.random()*10)+1));
